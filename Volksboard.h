...
byte geminiBits[ROWS][COLS] = {
  { B00100000, B00010000, B00001000, B00000100, B00000010, B00000001},
   ...
   {B00000000, B00100000, B00001000, B00000010, B01000000, B00000010},
...
#define Key_#1 (currentChord[0][0])
#define Key_#2 (currentChord[0][1])
#define Key_#3 (currentChord[0][2])
#define Key_#4 (currentChord[0][3])
#define Key_#5 (currentChord[0][4])
#define Key_#6 (currentChord[0][5])
#define Key_#7 (currentChord[3][0])
#define Key_#8 (currentChord[3][1])
#define Key_#9 (currentChord[3][2])
#define Key_#A (currentChord[3][3])
#define Key_#B (currentChord[3][4])
#define Key_#C (currentChord[3][5])
#define Key_*1 (currentChord[1][5])
#define Key_*2 (currentChord[2][5])
#define Key_*3 (currentChord[4][0])
#define Key_*4 (currentChord[5][0])
